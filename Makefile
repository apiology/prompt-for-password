...
release: dist ## package and upload a release
	...
	twine upload -u __token__ -p $$(with-op op item get 'PyPI - test' --fields api_key) dist/prompt-for-password-$${new_version:?}.tar.gz -r testpypi; \
	twine upload -u __token__ -p $$(with-op op item get 'PyPI' --fields api_key) dist/prompt-for-password-$${new_version:?}.tar.gz -r pypi
